...
@Profile("prod")
public class ProjectRepositoryInMemoryDbBasedImpl implements IProjectRepositoryInMemory {
    public static final Logger LOGGER = LoggerFactory.getLogger(ProjectRepositoryInMemoryDbBasedImpl.class);
    ...
    public ProjectRepositoryInMemoryDbBasedImpl(
